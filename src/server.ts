...
import { commissionScheduler } from './modules/tipster/commission.scheduler';
...
app.listen(port, () => {
    ...
    // Start creator-commission nightly payout (settled wins only, threshold-gated)
    if (process.env.CREATOR_COMMISSION !== 'disabled') {
