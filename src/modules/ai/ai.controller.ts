...
import { ChatConversationModel } from './chat-conversation.model';
...
export const chat = async (req: Request, res: Response) => {
  try {
    ...
    return res.json({ success: true, data: { content: result.content, actions: result.actions || [], usage: result.usage } });
  } catch (error) {
